...
Reference notes about people. Each person has their own note; this index holds the broad organizational notes and a roster grouped by team.

Titles, departments, reporting lines, and locations are reconciled against the [[People/Org Chart|Org Chart]] (full company reference). See that file to look up anyone not listed here.

> **Team membership is tracked manually here, not derived from the org chart.** Teams/squads (Blitz, Velocity, etc.) are fluid and do not map to reporting lines — the org chart is only a source for names, titles, and reporting structure.

> Some people are first-name-only or unmatched in the org chart. Add details to their note as confirmed.

## Reference

- [[People/Org Chart|Org Chart]] — full company org chart (confidential internal data)

## Me

- [[People/Matt Condie|Matt Condie]]

## Velocity ([[Velocity]])

- [[People/Tanner Davies|Tanner Davies]]
- [[People/Jake Knowlton|Jake Knowlton]]
- [[People/Mitchell Cannon|Mitchell Cannon]]

## Blitz ([[Blitz]])

- [[People/Peter Welty|Peter Welty]]
- [[People/Addison Zobrist|Addison Zobrist]]
- [[People/Trey Bailey|Trey Bailey]]
- [[People/Kyle Crowther|Kyle Crowther]]
- [[People/Ricky Roller|Ricky Roller]] _(former)_
...
- [[People/Gregory Mueller|Gregory Mueller]]
- [[People/Jessica Wright|Jessica Wright]]
- [[People/Mike Harris|Mike Harris]]
- [[People/David Montoya|David Montoya]]
...
- [[People/Colter Smith|Colter Smith]]

## Leadership / Other

- [[People/Chad Maughan|Chad Maughan]]
- [[People/Mike Jensen|Mike Jensen]]
- [[People/James Proctor|James Proctor]] _(DevOps / Internal Support)_
- [[People/Taylor Daily|Taylor Daily]] _(Finance — Data Strategy & Systems)_
